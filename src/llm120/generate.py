...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Require at least this many generated tokens before EOS can stop generation",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.1,
        help="Values above 1.0 discourage repeating the same tokens",
    )
    parser.add_argument(
        "--no-repeat-ngram-size",
        type=int,
        default=4,
        help="Block exact repeated n-grams; set to 0 to disable",
    )
...
def main() -> None:
    ...
    if args.min_new_tokens > 0:
        kwargs["min_new_tokens"] = args.min_new_tokens
